  ...
  return (
    <section className="max-w-245 my-0 mx-auto py-12 px-6 w-full">
      ...
      <p className="mt-0 mx-0 mb-7.5 font-medium text-vh-14 font-manrope text-vh-muted">
        O WhatsApp é nosso canal mais rápido — resposta em minutos no horário
        comercial.
      </p>
        ...
        <div className="flex flex-col gap-3">
          ...
          >
            ...
            <span className="flex flex-col gap-0.5">
              <span className="font-bold text-vh-15 font-space-grotesk">
                WhatsApp
              </span>
              <span className="font-semibold text-vh-13 font-manrope text-vh-wa">
                +55 96 98142-5135 · resposta rápida
              </span>
            </span>
          </a>
          <div className="bg-vh-card border border-vh-border rounded-vh-14 p-5 flex flex-col gap-2.5">
            <span className="font-semibold text-vh-13 font-manrope text-vh-soft">
              <span className="text-vh-accent font-bold">E-mail:</span>{" "}
              {settings.contactEmail}
            </span>
            <span className="font-semibold text-vh-13 font-manrope text-vh-soft">
              <span className="text-vh-accent font-bold">Endereço:</span>{" "}
              {settings.contactAddress}
            </span>
            <span className="font-semibold text-vh-13 font-manrope text-vh-soft">
              <span className="text-vh-accent font-bold">Horário:</span>{" "}
