      ...
      {orders && orders.length > 0 && (
        <div className="flex flex-col gap-3">
          {orders.map((order) => (
            ...
            >
              <span className="hidden sm:flex h-10.5 w-10.5 flex-none items-center justify-center rounded-full bg-vh-deep border border-vh-border">
                <Package aria-hidden="true" size={18} strokeWidth={1.75} className="text-vh-accent" />
              </span>
